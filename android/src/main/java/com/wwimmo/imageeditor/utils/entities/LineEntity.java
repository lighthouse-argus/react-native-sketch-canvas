...
public class LineEntity extends MotionEntity {
    ...
    public LineEntity(String entityId,
                        @NonNull Layer layer,
    ...
    private void configureRectBitmap(@Nullable Paint paint) {
        ...
        this.mRectCanvas.drawLine(this.mBordersPadding, getHeight() / 2, getWidth() - this.mBordersPadding, getHeight() / 2, this.mRectPaint);
